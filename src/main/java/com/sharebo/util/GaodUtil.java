...
public class GaodUtil {
	...
	public static void main(String[] args) {
		//System.out.println(createTable("章科",null));
		Map<String,String> 章科=new HashMap<String, String>();
		章科.put("zhangke", "aaaaaaaa");
		章科.put("bbb", "bbbbbbbb");
		//System.out.println(addTableDateOnLoctypeBylocation("章科的家", 11.1564645, 16.546546,章科));
		//System.out.println(addTableDateOnLoctypeByAddress("章科的母猪卡","章科的家！", 章科));
		//删除单个
		Set<String> s=new HashSet<String>();
		s.add("7");
		s.add("8");
		System.out.println(deleteData(s));;
		System.out.println(updateTableData("2", 章科));
	}*/
}
